...
from src.core.supervisor import route_next_step
...
def test_route_load_to_clean():
    ...
    assert route_next_step(state) == "clean"
...
def test_route_clean_to_analyze():
    ...
    assert route_next_step(state) == "analyze"
...
def test_route_analyze_to_visualize():
    ...
    assert route_next_step(state) == "visualize"
