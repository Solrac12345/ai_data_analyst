...
class AnalyzeRequest(BaseModel):
    ...
    report_path: str = Field(default="output/report.html", description="Path for the HTML report")
...
class AnalyzeResponse(BaseModel):
    ...
    report_url: Optional[str] = Field(default=None, description="Path to the generated report")
    insights: list[str] = Field(default_factory=list, description="Generated insights")
    errors: list[str] = Field(default_factory=list, description="Pipeline errors if any")